...
#   define _ELPP_GCC_VERSION (__GNUC__ * 10000 \
                               + __GNUC_MINOR__ * 100 \
                               + __GNUC_PATCHLEVEL__)
#   if defined(__GXX_EXPERIMENTAL_CXX0X__) && !defined(_DISABLE_CXX0X)
#      define _ELPP_CXX0X 1
#   elif (_ELPP_GCC_VERSION >= 40801) && !defined(_DISABLE_CXX11)
...
#   endif // (_MSC_VER >= 1400)
#   if (_MSC_VER == 1600) && !defined(_DISABLE_CXX0X)
#      define _ELPP_CXX0X 1
#   elif (_MSC_VER == 1700) && !defined(_DISABLE_CXX11)
#      define _ELPP_CXX11 1
#   endif // (_MSC_VER == 1600)
#else
#   define _ELPP_CRT_DBG_WARNINGS 0
...
#   if (_ELPP_CLANG_VERSION >= 30300) && !defined(_DISABLE_CXX11)
#      define _ELPP_CXX11 1
